                ...
                <form method="POST" action="/products">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" class="form-control border border-primary-subtle rounded-3"
                            id="productName" aria-describedby="productHelp" placeholder="Enter Product Name">
                    </div>
                    <div class="mb-3">
                        <label for="productPrice" class="form-label">Price</label>
                        <input type="text" name="price" class="form-control border border-primary-subtle rounded-3"
                            id="productPricePrice" aria-describedby="productPriceHelp"
                            placeholder="Enter Product Price">
                    </div>
                    <div class="d-flex justify-content-end">
                        <button type="submit"
                            class="btn btn-outline-primary btn-sm px-4 rounded-pill ms-2">Submit</button>
                    </div>
                </form>
            </div>
        </div>
